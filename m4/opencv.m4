...
# Copyright (C)  Benoit Sigoure <tsuna@lrde.epita.fr>
...
OPENCV_DEFUN([Imgproc],
  [opencv_imgproc_save_LIBS=$LIBS
   ...
   OPENCV_FIND_LIB([imgproc], [$1], [opencv2/imgproc.hpp], [
    using namespace cv;
    typedef void(*funptr)(InputArray, OutputArray, double, double, int, bool);
    return !(funptr)&cv::Canny;])
